    ...
    <section id="download" className="relative overflow-hidden border-y border-border bg-secondary/30">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24">
        <Reveal className="max-w-2xl">
          ...
          <p className="mt-4 text-muted-foreground">The DACEXY desktop app runs locally. After you sign in, connect the agent from inside the app and let DACEXY install and start the local OpenClaw runtime silently.</p>
        </Reveal>
