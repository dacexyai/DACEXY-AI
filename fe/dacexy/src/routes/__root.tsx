...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dacexy AI — Autonomous coding agents" },
      {
        name: "description",
        content: "Dacexy AI runs autonomous agents that read, write and ship code in your terminal.",
      },
      { name: "author", content: "Dacexy AI" },
      { property: "og:site_name", content: "Dacexy AI" },
