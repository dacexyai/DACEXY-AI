...
const TITLE = "Download Dacexy AI — Windows Desktop App";
const DESCRIPTION =
  "Download the Dacexy AI desktop app for Windows. Install once and let your AI employee run desktop, browser and document work locally.";
...
const install = [
  ["01", "Download the installer", "Download the Windows installer above."],
