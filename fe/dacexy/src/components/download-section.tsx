    ...
    <section id="download" className="relative overflow-hidden border-y border-border bg-secondary/30">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-6 text-3xl font-semibold md:text-5xl">Download the <span className="shine-text">DACEXY desktop app</span>.</h2>
          <p className="mt-4 text-muted-foreground">The desktop app runs locally and gives DACEXY secure access to your computer for real work.</p>
        </Reveal>
        ...
        {!compact && (
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {[
              ...
              [Cpu, "Runs locally", "Computer actions run locally on your machine."],
              [Download, "One Windows installer", "Install the verified Windows app in one step."],
            ].map(([Icon, t, d], i) => {
