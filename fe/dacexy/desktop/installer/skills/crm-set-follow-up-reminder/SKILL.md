---
name: crm-set-follow-up-reminder
description: Business automation skill - set follow-up reminder (crm). Use when the user asks to set follow-up reminder or a close equivalent in the crm domain.
---

# Set Follow-Up Reminder

## Goal
Help the user set follow-up reminder accurately and efficiently as part of Dacexy business automation (crm category).
