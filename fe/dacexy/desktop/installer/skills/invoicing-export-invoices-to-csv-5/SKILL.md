---
name: invoicing-export-invoices-to-csv-5
description: Business automation skill - export invoices to csv 5 (invoicing). Use when the user asks to export invoices to csv 5 or a close equivalent in the invoicing domain.
---

# Export Invoices To Csv 5

## Goal
Help the user export invoices to csv 5 accurately and efficiently as part of Dacexy business automation (invoicing category).
