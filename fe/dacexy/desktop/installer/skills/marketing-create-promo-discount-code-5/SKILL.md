---
name: marketing-create-promo-discount-code-5
description: Business automation skill - create promo discount code 5 (marketing). Use when the user asks to create promo discount code 5 or a close equivalent in the marketing domain.
---

# Create Promo Discount Code 5

## Goal
Help the user create promo discount code 5 accurately and efficiently as part of Dacexy business automation (marketing category).
