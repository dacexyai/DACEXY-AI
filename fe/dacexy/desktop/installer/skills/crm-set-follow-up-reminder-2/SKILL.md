---
name: crm-set-follow-up-reminder-2
description: Business automation skill - set follow-up reminder 2 (crm). Use when the user asks to set follow-up reminder 2 or a close equivalent in the crm domain.
---

# Set Follow-Up Reminder 2

## Goal
Help the user set follow-up reminder 2 accurately and efficiently as part of Dacexy business automation (crm category).
