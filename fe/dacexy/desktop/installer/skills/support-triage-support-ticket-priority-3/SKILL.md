---
name: support-triage-support-ticket-priority-3
description: Business automation skill - triage support ticket priority 3 (support). Use when the user asks to triage support ticket priority 3 or a close equivalent in the support domain.
---

# Triage Support Ticket Priority 3

## Goal
Help the user triage support ticket priority 3 accurately and efficiently as part of Dacexy business automation (support category).
