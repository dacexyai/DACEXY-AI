---
name: sales-build-sales-sequence
description: Business automation skill - build sales sequence (sales). Use when the user asks to build sales sequence or a close equivalent in the sales domain.
---

# Build Sales Sequence

## Goal
Help the user build sales sequence accurately and efficiently as part of Dacexy business automation (sales category).
