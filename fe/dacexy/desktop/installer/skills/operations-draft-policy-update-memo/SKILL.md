---
name: operations-draft-policy-update-memo
description: Business automation skill - draft policy update memo (operations). Use when the user asks to draft policy update memo or a close equivalent in the operations domain.
---

# Draft Policy Update Memo

## Goal
Help the user draft policy update memo accurately and efficiently as part of Dacexy business automation (operations category).
