---
name: ecommerce-apply-promo-to-cart-4
description: Business automation skill - apply promo to cart 4 (ecommerce). Use when the user asks to apply promo to cart 4 or a close equivalent in the ecommerce domain.
---

# Apply Promo To Cart 4

## Goal
Help the user apply promo to cart 4 accurately and efficiently as part of Dacexy business automation (ecommerce category).
