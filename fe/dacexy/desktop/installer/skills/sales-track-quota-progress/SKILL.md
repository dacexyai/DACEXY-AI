---
name: sales-track-quota-progress
description: Business automation skill - track quota progress (sales). Use when the user asks to track quota progress or a close equivalent in the sales domain.
---

# Track Quota Progress

## Goal
Help the user track quota progress accurately and efficiently as part of Dacexy business automation (sales category).
