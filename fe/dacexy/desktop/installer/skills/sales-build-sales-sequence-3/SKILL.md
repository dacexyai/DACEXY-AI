---
name: sales-build-sales-sequence-3
description: Business automation skill - build sales sequence 3 (sales). Use when the user asks to build sales sequence 3 or a close equivalent in the sales domain.
---

# Build Sales Sequence 3

## Goal
Help the user build sales sequence 3 accurately and efficiently as part of Dacexy business automation (sales category).
