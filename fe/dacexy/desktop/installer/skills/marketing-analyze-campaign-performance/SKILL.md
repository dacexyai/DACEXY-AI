---
name: marketing-analyze-campaign-performance
description: Business automation skill - analyze campaign performance (marketing). Use when the user asks to analyze campaign performance or a close equivalent in the marketing domain.
---

# Analyze Campaign Performance

## Goal
Help the user analyze campaign performance accurately and efficiently as part of Dacexy business automation (marketing category).
