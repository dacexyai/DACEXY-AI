---
name: ecommerce-flag-low-stock-sku-5
description: Business automation skill - flag low stock SKU 5 (ecommerce). Use when the user asks to flag low stock SKU 5 or a close equivalent in the ecommerce domain.
---

# Flag Low Stock Sku 5

## Goal
Help the user flag low stock SKU 5 accurately and efficiently as part of Dacexy business automation (ecommerce category).
