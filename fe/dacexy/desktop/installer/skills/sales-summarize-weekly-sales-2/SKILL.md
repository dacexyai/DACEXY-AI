---
name: sales-summarize-weekly-sales-2
description: Business automation skill - summarize weekly sales 2 (sales). Use when the user asks to summarize weekly sales 2 or a close equivalent in the sales domain.
---

# Summarize Weekly Sales 2

## Goal
Help the user summarize weekly sales 2 accurately and efficiently as part of Dacexy business automation (sales category).
