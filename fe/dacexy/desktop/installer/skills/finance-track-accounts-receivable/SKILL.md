---
name: finance-track-accounts-receivable
description: Business automation skill - track accounts receivable (finance). Use when the user asks to track accounts receivable or a close equivalent in the finance domain.
---

# Track Accounts Receivable

## Goal
Help the user track accounts receivable accurately and efficiently as part of Dacexy business automation (finance category).
