---
name: crm-import-contacts-csv-5
description: Business automation skill - import contacts csv 5 (crm). Use when the user asks to import contacts csv 5 or a close equivalent in the crm domain.
---

# Import Contacts Csv 5

## Goal
Help the user import contacts csv 5 accurately and efficiently as part of Dacexy business automation (crm category).
