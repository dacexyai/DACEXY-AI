---
name: crm-export-contacts-csv-3
description: Business automation skill - export contacts csv 3 (crm). Use when the user asks to export contacts csv 3 or a close equivalent in the crm domain.
---

# Export Contacts Csv 3

## Goal
Help the user export contacts csv 3 accurately and efficiently as part of Dacexy business automation (crm category).
