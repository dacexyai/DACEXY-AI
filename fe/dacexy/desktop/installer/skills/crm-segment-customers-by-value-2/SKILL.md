---
name: crm-segment-customers-by-value-2
description: Business automation skill - segment customers by value 2 (crm). Use when the user asks to segment customers by value 2 or a close equivalent in the crm domain.
---

# Segment Customers By Value 2

## Goal
Help the user segment customers by value 2 accurately and efficiently as part of Dacexy business automation (crm category).
