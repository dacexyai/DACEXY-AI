---
name: invoicing-match-payment-to-invoice
description: Business automation skill - match payment to invoice (invoicing). Use when the user asks to match payment to invoice or a close equivalent in the invoicing domain.
---

# Match Payment To Invoice

## Goal
Help the user match payment to invoice accurately and efficiently as part of Dacexy business automation (invoicing category).
