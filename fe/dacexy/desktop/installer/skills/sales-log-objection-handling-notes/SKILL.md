---
name: sales-log-objection-handling-notes
description: Business automation skill - log objection handling notes (sales). Use when the user asks to log objection handling notes or a close equivalent in the sales domain.
---

# Log Objection Handling Notes

## Goal
Help the user log objection handling notes accurately and efficiently as part of Dacexy business automation (sales category).
