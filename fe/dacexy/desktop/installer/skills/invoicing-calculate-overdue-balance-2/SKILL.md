---
name: invoicing-calculate-overdue-balance-2
description: Business automation skill - calculate overdue balance 2 (invoicing). Use when the user asks to calculate overdue balance 2 or a close equivalent in the invoicing domain.
---

# Calculate Overdue Balance 2

## Goal
Help the user calculate overdue balance 2 accurately and efficiently as part of Dacexy business automation (invoicing category).
