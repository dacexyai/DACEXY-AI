---
name: sales-track-quota-progress-2
description: Business automation skill - track quota progress 2 (sales). Use when the user asks to track quota progress 2 or a close equivalent in the sales domain.
---

# Track Quota Progress 2

## Goal
Help the user track quota progress 2 accurately and efficiently as part of Dacexy business automation (sales category).
