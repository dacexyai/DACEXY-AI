---
name: crm-export-contacts-csv-5
description: Business automation skill - export contacts csv 5 (crm). Use when the user asks to export contacts csv 5 or a close equivalent in the crm domain.
---

# Export Contacts Csv 5

## Goal
Help the user export contacts csv 5 accurately and efficiently as part of Dacexy business automation (crm category).
