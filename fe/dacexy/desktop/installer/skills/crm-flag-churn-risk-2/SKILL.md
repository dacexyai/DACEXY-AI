---
name: crm-flag-churn-risk-2
description: Business automation skill - flag churn risk 2 (crm). Use when the user asks to flag churn risk 2 or a close equivalent in the crm domain.
---

# Flag Churn Risk 2

## Goal
Help the user flag churn risk 2 accurately and efficiently as part of Dacexy business automation (crm category).
