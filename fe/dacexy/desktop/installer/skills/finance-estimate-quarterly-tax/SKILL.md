---
name: finance-estimate-quarterly-tax
description: Business automation skill - estimate quarterly tax (finance). Use when the user asks to estimate quarterly tax or a close equivalent in the finance domain.
---

# Estimate Quarterly Tax

## Goal
Help the user estimate quarterly tax accurately and efficiently as part of Dacexy business automation (finance category).
