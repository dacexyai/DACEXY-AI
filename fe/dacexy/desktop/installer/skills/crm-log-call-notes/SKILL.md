---
name: crm-log-call-notes
description: Business automation skill - log call notes (crm). Use when the user asks to log call notes or a close equivalent in the crm domain.
---

# Log Call Notes

## Goal
Help the user log call notes accurately and efficiently as part of Dacexy business automation (crm category).
