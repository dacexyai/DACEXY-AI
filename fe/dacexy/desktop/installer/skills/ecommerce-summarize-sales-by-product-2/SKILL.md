---
name: ecommerce-summarize-sales-by-product-2
description: Business automation skill - summarize sales by product 2 (ecommerce). Use when the user asks to summarize sales by product 2 or a close equivalent in the ecommerce domain.
---

# Summarize Sales By Product 2

## Goal
Help the user summarize sales by product 2 accurately and efficiently as part of Dacexy business automation (ecommerce category).
