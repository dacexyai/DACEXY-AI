---
name: hr-calculate-payroll-summary
description: Business automation skill - calculate payroll summary (hr). Use when the user asks to calculate payroll summary or a close equivalent in the hr domain.
---

# Calculate Payroll Summary

## Goal
Help the user calculate payroll summary accurately and efficiently as part of Dacexy business automation (hr category).
