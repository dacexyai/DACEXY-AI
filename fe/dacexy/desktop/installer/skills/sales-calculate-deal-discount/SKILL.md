---
name: sales-calculate-deal-discount
description: Business automation skill - calculate deal discount (sales). Use when the user asks to calculate deal discount or a close equivalent in the sales domain.
---

# Calculate Deal Discount

## Goal
Help the user calculate deal discount accurately and efficiently as part of Dacexy business automation (sales category).
