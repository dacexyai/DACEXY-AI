---
name: ecommerce-calculate-shipping-cost
description: Business automation skill - calculate shipping cost (ecommerce). Use when the user asks to calculate shipping cost or a close equivalent in the ecommerce domain.
---

# Calculate Shipping Cost

## Goal
Help the user calculate shipping cost accurately and efficiently as part of Dacexy business automation (ecommerce category).
