---
name: invoicing-email-invoice-pdf-3
description: Business automation skill - email invoice pdf 3 (invoicing). Use when the user asks to email invoice pdf 3 or a close equivalent in the invoicing domain.
---

# Email Invoice Pdf 3

## Goal
Help the user email invoice pdf 3 accurately and efficiently as part of Dacexy business automation (invoicing category).
