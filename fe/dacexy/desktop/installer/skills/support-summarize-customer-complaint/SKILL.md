---
name: support-summarize-customer-complaint
description: Business automation skill - summarize customer complaint (support). Use when the user asks to summarize customer complaint or a close equivalent in the support domain.
---

# Summarize Customer Complaint

## Goal
Help the user summarize customer complaint accurately and efficiently as part of Dacexy business automation (support category).
