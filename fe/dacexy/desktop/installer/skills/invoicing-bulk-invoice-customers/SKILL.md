---
name: invoicing-bulk-invoice-customers
description: Business automation skill - bulk invoice customers (invoicing). Use when the user asks to bulk invoice customers or a close equivalent in the invoicing domain.
---

# Bulk Invoice Customers

## Goal
Help the user bulk invoice customers accurately and efficiently as part of Dacexy business automation (invoicing category).
