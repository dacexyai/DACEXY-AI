---
name: support-summarize-support-ticket-trends
description: Business automation skill - summarize support ticket trends (support). Use when the user asks to summarize support ticket trends or a close equivalent in the support domain.
---

# Summarize Support Ticket Trends

## Goal
Help the user summarize support ticket trends accurately and efficiently as part of Dacexy business automation (support category).
