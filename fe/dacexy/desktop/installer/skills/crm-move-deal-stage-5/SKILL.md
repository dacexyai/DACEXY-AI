---
name: crm-move-deal-stage-5
description: Business automation skill - move deal stage 5 (crm). Use when the user asks to move deal stage 5 or a close equivalent in the crm domain.
---

# Move Deal Stage 5

## Goal
Help the user move deal stage 5 accurately and efficiently as part of Dacexy business automation (crm category).
