---
name: invoicing-apply-discount-to-invoice
description: Business automation skill - apply discount to invoice (invoicing). Use when the user asks to apply discount to invoice or a close equivalent in the invoicing domain.
---

# Apply Discount To Invoice

## Goal
Help the user apply discount to invoice accurately and efficiently as part of Dacexy business automation (invoicing category).
