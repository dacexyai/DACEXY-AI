---
name: marketing-write-email-campaign
description: Business automation skill - write email campaign (marketing). Use when the user asks to write email campaign or a close equivalent in the marketing domain.
---

# Write Email Campaign

## Goal
Help the user write email campaign accurately and efficiently as part of Dacexy business automation (marketing category).
