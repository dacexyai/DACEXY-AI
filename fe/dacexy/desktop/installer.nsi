...
Section "Install"
  ...
  ; Register the DACEXY desktop deep-link so the website can hand off to the installed app.
  WriteRegStr HKCU "Software\Classes\dacexy" "" "URL:DACEXY AI"
  WriteRegStr HKCU "Software\Classes\dacexy" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\dacexy\shell\open\command" "" '"$INSTDIR\${EXENAME}" "%1"'
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\dacexy"
