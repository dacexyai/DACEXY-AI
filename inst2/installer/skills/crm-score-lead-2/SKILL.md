---
name: crm-score-lead-2
description: Business automation skill - score lead 2 (crm). Use when the user asks to score lead 2 or a close equivalent in the crm domain.
---

# Score Lead 2

## Goal
Help the user score lead 2 accurately and efficiently as part of Dacexy business automation (crm category).
