---
name: support-draft-support-reply-2
description: Business automation skill - draft support reply 2 (support). Use when the user asks to draft support reply 2 or a close equivalent in the support domain.
---

# Draft Support Reply 2

## Goal
Help the user draft support reply 2 accurately and efficiently as part of Dacexy business automation (support category).
