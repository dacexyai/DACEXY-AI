---
name: invoicing-generate-tax-summary
description: Business automation skill - generate tax summary (invoicing). Use when the user asks to generate tax summary or a close equivalent in the invoicing domain.
---

# Generate Tax Summary

## Goal
Help the user generate tax summary accurately and efficiently as part of Dacexy business automation (invoicing category).
