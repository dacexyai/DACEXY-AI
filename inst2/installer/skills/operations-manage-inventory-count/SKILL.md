---
name: operations-manage-inventory-count
description: Business automation skill - manage inventory count (operations). Use when the user asks to manage inventory count or a close equivalent in the operations domain.
---

# Manage Inventory Count

## Goal
Help the user manage inventory count accurately and efficiently as part of Dacexy business automation (operations category).
