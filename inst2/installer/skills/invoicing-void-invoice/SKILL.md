---
name: invoicing-void-invoice
description: Business automation skill - void invoice (invoicing). Use when the user asks to void invoice or a close equivalent in the invoicing domain.
---

# Void Invoice

## Goal
Help the user void invoice accurately and efficiently as part of Dacexy business automation (invoicing category).
