---
name: sales-build-sales-sequence-4
description: Business automation skill - build sales sequence 4 (sales). Use when the user asks to build sales sequence 4 or a close equivalent in the sales domain.
---

# Build Sales Sequence 4

## Goal
Help the user build sales sequence 4 accurately and efficiently as part of Dacexy business automation (sales category).
