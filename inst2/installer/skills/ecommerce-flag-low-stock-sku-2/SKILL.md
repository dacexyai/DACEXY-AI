---
name: ecommerce-flag-low-stock-sku-2
description: Business automation skill - flag low stock SKU 2 (ecommerce). Use when the user asks to flag low stock SKU 2 or a close equivalent in the ecommerce domain.
---

# Flag Low Stock Sku 2

## Goal
Help the user flag low stock SKU 2 accurately and efficiently as part of Dacexy business automation (ecommerce category).
