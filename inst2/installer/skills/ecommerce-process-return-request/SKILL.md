---
name: ecommerce-process-return-request
description: Business automation skill - process return request (ecommerce). Use when the user asks to process return request or a close equivalent in the ecommerce domain.
---

# Process Return Request

## Goal
Help the user process return request accurately and efficiently as part of Dacexy business automation (ecommerce category).
