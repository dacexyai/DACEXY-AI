---
name: ecommerce-update-product-listing
description: Business automation skill - update product listing (ecommerce). Use when the user asks to update product listing or a close equivalent in the ecommerce domain.
---

# Update Product Listing

## Goal
Help the user update product listing accurately and efficiently as part of Dacexy business automation (ecommerce category).
