---
name: crm-merge-duplicate-contacts-4
description: Business automation skill - merge duplicate contacts 4 (crm). Use when the user asks to merge duplicate contacts 4 or a close equivalent in the crm domain.
---

# Merge Duplicate Contacts 4

## Goal
Help the user merge duplicate contacts 4 accurately and efficiently as part of Dacexy business automation (crm category).
