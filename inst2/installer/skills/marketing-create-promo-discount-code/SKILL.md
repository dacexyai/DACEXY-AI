---
name: marketing-create-promo-discount-code
description: Business automation skill - create promo discount code (marketing). Use when the user asks to create promo discount code or a close equivalent in the marketing domain.
---

# Create Promo Discount Code

## Goal
Help the user create promo discount code accurately and efficiently as part of Dacexy business automation (marketing category).
