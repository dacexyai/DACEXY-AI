---
name: operations-audit-process-checklist-2
description: Business automation skill - audit process checklist 2 (operations). Use when the user asks to audit process checklist 2 or a close equivalent in the operations domain.
---

# Audit Process Checklist 2

## Goal
Help the user audit process checklist 2 accurately and efficiently as part of Dacexy business automation (operations category).
