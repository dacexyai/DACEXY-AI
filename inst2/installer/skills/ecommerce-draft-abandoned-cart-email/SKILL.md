---
name: ecommerce-draft-abandoned-cart-email
description: Business automation skill - draft abandoned cart email (ecommerce). Use when the user asks to draft abandoned cart email or a close equivalent in the ecommerce domain.
---

# Draft Abandoned Cart Email

## Goal
Help the user draft abandoned cart email accurately and efficiently as part of Dacexy business automation (ecommerce category).
