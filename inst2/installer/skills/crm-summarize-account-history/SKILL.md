---
name: crm-summarize-account-history
description: Business automation skill - summarize account history (crm). Use when the user asks to summarize account history or a close equivalent in the crm domain.
---

# Summarize Account History

## Goal
Help the user summarize account history accurately and efficiently as part of Dacexy business automation (crm category).
