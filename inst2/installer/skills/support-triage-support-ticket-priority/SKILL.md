---
name: support-triage-support-ticket-priority
description: Business automation skill - triage support ticket priority (support). Use when the user asks to triage support ticket priority or a close equivalent in the support domain.
---

# Triage Support Ticket Priority

## Goal
Help the user triage support ticket priority accurately and efficiently as part of Dacexy business automation (support category).
