---
name: crm-log-lead-2
description: Business automation skill - log lead 2 (crm). Use when the user asks to log lead 2 or a close equivalent in the crm domain.
---

# Log Lead 2

## Goal
Help the user log lead 2 accurately and efficiently as part of Dacexy business automation (crm category).
