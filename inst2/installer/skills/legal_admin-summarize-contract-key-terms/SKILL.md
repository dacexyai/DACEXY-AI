---
name: legal_admin-summarize-contract-key-terms
description: Business automation skill - summarize contract key terms (legal admin). Use when the user asks to summarize contract key terms or a close equivalent in the legal admin domain.
---

# Summarize Contract Key Terms

## Goal
Help the user summarize contract key terms accurately and efficiently as part of Dacexy business automation (legal admin category).
