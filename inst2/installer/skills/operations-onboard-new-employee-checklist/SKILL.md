---
name: operations-onboard-new-employee-checklist
description: Business automation skill - onboard new employee checklist (operations). Use when the user asks to onboard new employee checklist or a close equivalent in the operations domain.
---

# Onboard New Employee Checklist

## Goal
Help the user onboard new employee checklist accurately and efficiently as part of Dacexy business automation (operations category).
