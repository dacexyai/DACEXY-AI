---
name: crm-segment-customers-by-value-4
description: Business automation skill - segment customers by value 4 (crm). Use when the user asks to segment customers by value 4 or a close equivalent in the crm domain.
---

# Segment Customers By Value 4

## Goal
Help the user segment customers by value 4 accurately and efficiently as part of Dacexy business automation (crm category).
