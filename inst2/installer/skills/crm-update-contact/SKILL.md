...
description: Business automation skill - update contact (crm). Use when the user asks to update contact or a close equivalent in the crm domain.
---

# Update Contact

## Goal
Help the user update contact accurately and efficiently as part of Dacexy business automation (crm category).
