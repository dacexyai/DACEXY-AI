---
name: crm-merge-duplicate-contacts
description: Business automation skill - merge duplicate contacts (crm). Use when the user asks to merge duplicate contacts or a close equivalent in the crm domain.
---

# Merge Duplicate Contacts

## Goal
Help the user merge duplicate contacts accurately and efficiently as part of Dacexy business automation (crm category).
