---
name: support-close-resolved-ticket-3
description: Business automation skill - close resolved ticket 3 (support). Use when the user asks to close resolved ticket 3 or a close equivalent in the support domain.
---

# Close Resolved Ticket 3

## Goal
Help the user close resolved ticket 3 accurately and efficiently as part of Dacexy business automation (support category).
