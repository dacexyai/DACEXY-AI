---
name: sales-build-sales-proposal
description: Business automation skill - build sales proposal (sales). Use when the user asks to build sales proposal or a close equivalent in the sales domain.
---

# Build Sales Proposal

## Goal
Help the user build sales proposal accurately and efficiently as part of Dacexy business automation (sales category).
