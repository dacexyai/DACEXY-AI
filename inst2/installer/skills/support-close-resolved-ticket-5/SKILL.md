---
name: support-close-resolved-ticket-5
description: Business automation skill - close resolved ticket 5 (support). Use when the user asks to close resolved ticket 5 or a close equivalent in the support domain.
---

# Close Resolved Ticket 5

## Goal
Help the user close resolved ticket 5 accurately and efficiently as part of Dacexy business automation (support category).
