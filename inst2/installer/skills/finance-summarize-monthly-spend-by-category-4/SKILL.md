---
name: finance-summarize-monthly-spend-by-category-4
description: Business automation skill - summarize monthly spend by category 4 (finance). Use when the user asks to summarize monthly spend by category 4 or a close equivalent in the finance domain.
---

# Summarize Monthly Spend By Category 4

## Goal
Help the user summarize monthly spend by category 4 accurately and efficiently as part of Dacexy business automation (finance category).
