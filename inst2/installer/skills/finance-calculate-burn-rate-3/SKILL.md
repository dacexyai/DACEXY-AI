---
name: finance-calculate-burn-rate-3
description: Business automation skill - calculate burn rate 3 (finance). Use when the user asks to calculate burn rate 3 or a close equivalent in the finance domain.
---

# Calculate Burn Rate 3

## Goal
Help the user calculate burn rate 3 accurately and efficiently as part of Dacexy business automation (finance category).
