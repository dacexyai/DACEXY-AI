---
name: invoicing-generate-tax-summary-2
description: Business automation skill - generate tax summary 2 (invoicing). Use when the user asks to generate tax summary 2 or a close equivalent in the invoicing domain.
---

# Generate Tax Summary 2

## Goal
Help the user generate tax summary 2 accurately and efficiently as part of Dacexy business automation (invoicing category).
