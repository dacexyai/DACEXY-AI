---
name: invoicing-email-invoice-pdf-5
description: Business automation skill - email invoice pdf 5 (invoicing). Use when the user asks to email invoice pdf 5 or a close equivalent in the invoicing domain.
---

# Email Invoice Pdf 5

## Goal
Help the user email invoice pdf 5 accurately and efficiently as part of Dacexy business automation (invoicing category).
