---
name: finance-prepare-expense-report
description: Business automation skill - prepare expense report (finance). Use when the user asks to prepare expense report or a close equivalent in the finance domain.
---

# Prepare Expense Report

## Goal
Help the user prepare expense report accurately and efficiently as part of Dacexy business automation (finance category).
