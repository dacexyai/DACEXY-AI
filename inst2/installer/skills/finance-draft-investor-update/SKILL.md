---
name: finance-draft-investor-update
description: Business automation skill - draft investor update (finance). Use when the user asks to draft investor update or a close equivalent in the finance domain.
---

# Draft Investor Update

## Goal
Help the user draft investor update accurately and efficiently as part of Dacexy business automation (finance category).
