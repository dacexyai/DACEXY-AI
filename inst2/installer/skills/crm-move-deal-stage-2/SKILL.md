---
name: crm-move-deal-stage-2
description: Business automation skill - move deal stage 2 (crm). Use when the user asks to move deal stage 2 or a close equivalent in the crm domain.
---

# Move Deal Stage 2

## Goal
Help the user move deal stage 2 accurately and efficiently as part of Dacexy business automation (crm category).
