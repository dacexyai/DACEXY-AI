---
name: crm-export-contacts-csv-2
description: Business automation skill - export contacts csv 2 (crm). Use when the user asks to export contacts csv 2 or a close equivalent in the crm domain.
---

# Export Contacts Csv 2

## Goal
Help the user export contacts csv 2 accurately and efficiently as part of Dacexy business automation (crm category).
