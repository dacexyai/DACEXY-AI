---
name: finance-calculate-burn-rate-4
description: Business automation skill - calculate burn rate 4 (finance). Use when the user asks to calculate burn rate 4 or a close equivalent in the finance domain.
---

# Calculate Burn Rate 4

## Goal
Help the user calculate burn rate 4 accurately and efficiently as part of Dacexy business automation (finance category).
