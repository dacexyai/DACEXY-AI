---
name: marketing-segment-email-list-4
description: Business automation skill - segment email list 4 (marketing). Use when the user asks to segment email list 4 or a close equivalent in the marketing domain.
---

# Segment Email List 4

## Goal
Help the user segment email list 4 accurately and efficiently as part of Dacexy business automation (marketing category).
