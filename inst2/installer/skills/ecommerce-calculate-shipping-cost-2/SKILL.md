---
name: ecommerce-calculate-shipping-cost-2
description: Business automation skill - calculate shipping cost 2 (ecommerce). Use when the user asks to calculate shipping cost 2 or a close equivalent in the ecommerce domain.
---

# Calculate Shipping Cost 2

## Goal
Help the user calculate shipping cost 2 accurately and efficiently as part of Dacexy business automation (ecommerce category).
