---
name: finance-flag-unusual-transaction-5
description: Business automation skill - flag unusual transaction 5 (finance). Use when the user asks to flag unusual transaction 5 or a close equivalent in the finance domain.
---

# Flag Unusual Transaction 5

## Goal
Help the user flag unusual transaction 5 accurately and efficiently as part of Dacexy business automation (finance category).
