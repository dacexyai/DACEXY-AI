---
name: support-log-bug-report-2
description: Business automation skill - log bug report 2 (support). Use when the user asks to log bug report 2 or a close equivalent in the support domain.
---

# Log Bug Report 2

## Goal
Help the user log bug report 2 accurately and efficiently as part of Dacexy business automation (support category).
