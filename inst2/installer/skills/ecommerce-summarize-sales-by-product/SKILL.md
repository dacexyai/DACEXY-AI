---
name: ecommerce-summarize-sales-by-product
description: Business automation skill - summarize sales by product (ecommerce). Use when the user asks to summarize sales by product or a close equivalent in the ecommerce domain.
---

# Summarize Sales By Product

## Goal
Help the user summarize sales by product accurately and efficiently as part of Dacexy business automation (ecommerce category).
