---
name: crm-tag-customer-2
description: Business automation skill - tag customer 2 (crm). Use when the user asks to tag customer 2 or a close equivalent in the crm domain.
---

# Tag Customer 2

## Goal
Help the user tag customer 2 accurately and efficiently as part of Dacexy business automation (crm category).
