---
name: sales-identify-upsell-opportunity
description: Business automation skill - identify upsell opportunity (sales). Use when the user asks to identify upsell opportunity or a close equivalent in the sales domain.
---

# Identify Upsell Opportunity

## Goal
Help the user identify upsell opportunity accurately and efficiently as part of Dacexy business automation (sales category).
