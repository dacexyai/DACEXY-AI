---
name: crm-import-contacts-csv
description: Business automation skill - import contacts csv (crm). Use when the user asks to import contacts csv or a close equivalent in the crm domain.
---

# Import Contacts Csv

## Goal
Help the user import contacts csv accurately and efficiently as part of Dacexy business automation (crm category).
