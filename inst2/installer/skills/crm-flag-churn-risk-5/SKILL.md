---
name: crm-flag-churn-risk-5
description: Business automation skill - flag churn risk 5 (crm). Use when the user asks to flag churn risk 5 or a close equivalent in the crm domain.
---

# Flag Churn Risk 5

## Goal
Help the user flag churn risk 5 accurately and efficiently as part of Dacexy business automation (crm category).
