---
name: crm-flag-churn-risk
description: Business automation skill - flag churn risk (crm). Use when the user asks to flag churn risk or a close equivalent in the crm domain.
---

# Flag Churn Risk

## Goal
Help the user flag churn risk accurately and efficiently as part of Dacexy business automation (crm category).
