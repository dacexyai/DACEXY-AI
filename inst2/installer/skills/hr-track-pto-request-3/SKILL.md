---
name: hr-track-pto-request-3
description: Business automation skill - track PTO request 3 (hr). Use when the user asks to track PTO request 3 or a close equivalent in the hr domain.
---

# Track Pto Request 3

## Goal
Help the user track PTO request 3 accurately and efficiently as part of Dacexy business automation (hr category).
