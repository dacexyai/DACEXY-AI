---
name: finance-track-accounts-payable
description: Business automation skill - track accounts payable (finance). Use when the user asks to track accounts payable or a close equivalent in the finance domain.
---

# Track Accounts Payable

## Goal
Help the user track accounts payable accurately and efficiently as part of Dacexy business automation (finance category).
