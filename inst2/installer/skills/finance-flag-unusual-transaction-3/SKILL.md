---
name: finance-flag-unusual-transaction-3
description: Business automation skill - flag unusual transaction 3 (finance). Use when the user asks to flag unusual transaction 3 or a close equivalent in the finance domain.
---

# Flag Unusual Transaction 3

## Goal
Help the user flag unusual transaction 3 accurately and efficiently as part of Dacexy business automation (finance category).
