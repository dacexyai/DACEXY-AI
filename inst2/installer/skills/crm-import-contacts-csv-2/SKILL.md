---
name: crm-import-contacts-csv-2
description: Business automation skill - import contacts csv 2 (crm). Use when the user asks to import contacts csv 2 or a close equivalent in the crm domain.
---

# Import Contacts Csv 2

## Goal
Help the user import contacts csv 2 accurately and efficiently as part of Dacexy business automation (crm category).
