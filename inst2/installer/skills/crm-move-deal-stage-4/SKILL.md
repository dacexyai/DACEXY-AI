---
name: crm-move-deal-stage-4
description: Business automation skill - move deal stage 4 (crm). Use when the user asks to move deal stage 4 or a close equivalent in the crm domain.
---

# Move Deal Stage 4

## Goal
Help the user move deal stage 4 accurately and efficiently as part of Dacexy business automation (crm category).
