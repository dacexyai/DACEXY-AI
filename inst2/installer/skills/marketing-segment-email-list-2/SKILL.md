---
name: marketing-segment-email-list-2
description: Business automation skill - segment email list 2 (marketing). Use when the user asks to segment email list 2 or a close equivalent in the marketing domain.
---

# Segment Email List 2

## Goal
Help the user segment email list 2 accurately and efficiently as part of Dacexy business automation (marketing category).
