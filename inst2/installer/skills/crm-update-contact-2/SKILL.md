---
name: crm-update-contact-2
description: Business automation skill - update contact 2 (crm). Use when the user asks to update contact 2 or a close equivalent in the crm domain.
---

# Update Contact 2

## Goal
Help the user update contact 2 accurately and efficiently as part of Dacexy business automation (crm category).
