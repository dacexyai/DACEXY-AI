---
name: operations-draft-vendor-email
description: Business automation skill - draft vendor email (operations). Use when the user asks to draft vendor email or a close equivalent in the operations domain.
---

# Draft Vendor Email

## Goal
Help the user draft vendor email accurately and efficiently as part of Dacexy business automation (operations category).
