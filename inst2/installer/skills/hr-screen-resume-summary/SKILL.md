---
name: hr-screen-resume-summary
description: Business automation skill - screen resume summary (hr). Use when the user asks to screen resume summary or a close equivalent in the hr domain.
---

# Screen Resume Summary

## Goal
Help the user screen resume summary accurately and efficiently as part of Dacexy business automation (hr category).
