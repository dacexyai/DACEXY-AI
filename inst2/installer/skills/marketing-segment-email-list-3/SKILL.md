---
name: marketing-segment-email-list-3
description: Business automation skill - segment email list 3 (marketing). Use when the user asks to segment email list 3 or a close equivalent in the marketing domain.
---

# Segment Email List 3

## Goal
Help the user segment email list 3 accurately and efficiently as part of Dacexy business automation (marketing category).
