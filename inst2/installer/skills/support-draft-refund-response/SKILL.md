---
name: support-draft-refund-response
description: Business automation skill - draft refund response (support). Use when the user asks to draft refund response or a close equivalent in the support domain.
---

# Draft Refund Response

## Goal
Help the user draft refund response accurately and efficiently as part of Dacexy business automation (support category).
