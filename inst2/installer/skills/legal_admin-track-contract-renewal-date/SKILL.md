---
name: legal_admin-track-contract-renewal-date
description: Business automation skill - track contract renewal date (legal admin). Use when the user asks to track contract renewal date or a close equivalent in the legal admin domain.
---

# Track Contract Renewal Date

## Goal
Help the user track contract renewal date accurately and efficiently as part of Dacexy business automation (legal admin category).
