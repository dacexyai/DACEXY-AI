---
name: finance-categorize-expense-5
description: Business automation skill - categorize expense 5 (finance). Use when the user asks to categorize expense 5 or a close equivalent in the finance domain.
---

# Categorize Expense 5

## Goal
Help the user categorize expense 5 accurately and efficiently as part of Dacexy business automation (finance category).
