---
name: operations-track-kpi-dashboard-update
description: Business automation skill - track KPI dashboard update (operations). Use when the user asks to track KPI dashboard update or a close equivalent in the operations domain.
---

# Track Kpi Dashboard Update

## Goal
Help the user track KPI dashboard update accurately and efficiently as part of Dacexy business automation (operations category).
