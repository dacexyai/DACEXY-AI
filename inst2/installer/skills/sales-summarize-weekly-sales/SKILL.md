---
name: sales-summarize-weekly-sales
description: Business automation skill - summarize weekly sales (sales). Use when the user asks to summarize weekly sales or a close equivalent in the sales domain.
---

# Summarize Weekly Sales

## Goal
Help the user summarize weekly sales accurately and efficiently as part of Dacexy business automation (sales category).
