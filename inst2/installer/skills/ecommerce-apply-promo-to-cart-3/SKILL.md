---
name: ecommerce-apply-promo-to-cart-3
description: Business automation skill - apply promo to cart 3 (ecommerce). Use when the user asks to apply promo to cart 3 or a close equivalent in the ecommerce domain.
---

# Apply Promo To Cart 3

## Goal
Help the user apply promo to cart 3 accurately and efficiently as part of Dacexy business automation (ecommerce category).
