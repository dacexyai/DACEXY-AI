---
name: finance-forecast-cash-flow
description: Business automation skill - forecast cash flow (finance). Use when the user asks to forecast cash flow or a close equivalent in the finance domain.
---

# Forecast Cash Flow

## Goal
Help the user forecast cash flow accurately and efficiently as part of Dacexy business automation (finance category).
