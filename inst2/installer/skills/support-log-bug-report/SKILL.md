---
name: support-log-bug-report
description: Business automation skill - log bug report (support). Use when the user asks to log bug report or a close equivalent in the support domain.
---

# Log Bug Report

## Goal
Help the user log bug report accurately and efficiently as part of Dacexy business automation (support category).
