---
name: finance-calculate-break-even-point
description: Business automation skill - calculate break-even point (finance). Use when the user asks to calculate break-even point or a close equivalent in the finance domain.
---

# Calculate Break-Even Point

## Goal
Help the user calculate break-even point accurately and efficiently as part of Dacexy business automation (finance category).
