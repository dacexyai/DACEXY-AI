---
name: invoicing-send-invoice-reminder
description: Business automation skill - send invoice reminder (invoicing). Use when the user asks to send invoice reminder or a close equivalent in the invoicing domain.
---

# Send Invoice Reminder

## Goal
Help the user send invoice reminder accurately and efficiently as part of Dacexy business automation (invoicing category).
