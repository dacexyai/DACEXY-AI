---
name: invoicing-bulk-invoice-customers-2
description: Business automation skill - bulk invoice customers 2 (invoicing). Use when the user asks to bulk invoice customers 2 or a close equivalent in the invoicing domain.
---

# Bulk Invoice Customers 2

## Goal
Help the user bulk invoice customers 2 accurately and efficiently as part of Dacexy business automation (invoicing category).
