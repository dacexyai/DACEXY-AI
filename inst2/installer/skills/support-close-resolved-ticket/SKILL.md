---
name: support-close-resolved-ticket
description: Business automation skill - close resolved ticket (support). Use when the user asks to close resolved ticket or a close equivalent in the support domain.
---

# Close Resolved Ticket

## Goal
Help the user close resolved ticket accurately and efficiently as part of Dacexy business automation (support category).
