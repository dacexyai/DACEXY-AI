---
name: ecommerce-flag-low-stock-sku
description: Business automation skill - flag low stock SKU (ecommerce). Use when the user asks to flag low stock SKU or a close equivalent in the ecommerce domain.
---

# Flag Low Stock Sku

## Goal
Help the user flag low stock SKU accurately and efficiently as part of Dacexy business automation (ecommerce category).
