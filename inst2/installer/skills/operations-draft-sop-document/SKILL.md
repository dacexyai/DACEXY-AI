---
name: operations-draft-sop-document
description: Business automation skill - draft SOP document (operations). Use when the user asks to draft SOP document or a close equivalent in the operations domain.
---

# Draft Sop Document

## Goal
Help the user draft SOP document accurately and efficiently as part of Dacexy business automation (operations category).
