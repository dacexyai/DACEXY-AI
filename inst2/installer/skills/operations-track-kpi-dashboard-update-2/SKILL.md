---
name: operations-track-kpi-dashboard-update-2
description: Business automation skill - track KPI dashboard update 2 (operations). Use when the user asks to track KPI dashboard update 2 or a close equivalent in the operations domain.
---

# Track Kpi Dashboard Update 2

## Goal
Help the user track KPI dashboard update 2 accurately and efficiently as part of Dacexy business automation (operations category).
