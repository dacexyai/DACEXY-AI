---
name: finance-summarize-monthly-spend-by-category
description: Business automation skill - summarize monthly spend by category (finance). Use when the user asks to summarize monthly spend by category or a close equivalent in the finance domain.
---

# Summarize Monthly Spend By Category

## Goal
Help the user summarize monthly spend by category accurately and efficiently as part of Dacexy business automation (finance category).
