---
name: ecommerce-apply-promo-to-cart
description: Business automation skill - apply promo to cart (ecommerce). Use when the user asks to apply promo to cart or a close equivalent in the ecommerce domain.
---

# Apply Promo To Cart

## Goal
Help the user apply promo to cart accurately and efficiently as part of Dacexy business automation (ecommerce category).
