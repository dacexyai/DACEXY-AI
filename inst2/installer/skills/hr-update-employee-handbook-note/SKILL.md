---
name: hr-update-employee-handbook-note
description: Business automation skill - update employee handbook note (hr). Use when the user asks to update employee handbook note or a close equivalent in the hr domain.
---

# Update Employee Handbook Note

## Goal
Help the user update employee handbook note accurately and efficiently as part of Dacexy business automation (hr category).
