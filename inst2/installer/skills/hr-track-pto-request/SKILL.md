---
name: hr-track-pto-request
description: Business automation skill - track PTO request (hr). Use when the user asks to track PTO request or a close equivalent in the hr domain.
---

# Track Pto Request

## Goal
Help the user track PTO request accurately and efficiently as part of Dacexy business automation (hr category).
