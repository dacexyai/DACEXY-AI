---
name: sales-calculate-deal-discount-5
description: Business automation skill - calculate deal discount 5 (sales). Use when the user asks to calculate deal discount 5 or a close equivalent in the sales domain.
---

# Calculate Deal Discount 5

## Goal
Help the user calculate deal discount 5 accurately and efficiently as part of Dacexy business automation (sales category).
