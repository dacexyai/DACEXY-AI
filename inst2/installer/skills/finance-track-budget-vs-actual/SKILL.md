---
name: finance-track-budget-vs-actual
description: Business automation skill - track budget vs actual (finance). Use when the user asks to track budget vs actual or a close equivalent in the finance domain.
---

# Track Budget Vs Actual

## Goal
Help the user track budget vs actual accurately and efficiently as part of Dacexy business automation (finance category).
