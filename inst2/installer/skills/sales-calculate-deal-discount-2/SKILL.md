---
name: sales-calculate-deal-discount-2
description: Business automation skill - calculate deal discount 2 (sales). Use when the user asks to calculate deal discount 2 or a close equivalent in the sales domain.
---

# Calculate Deal Discount 2

## Goal
Help the user calculate deal discount 2 accurately and efficiently as part of Dacexy business automation (sales category).
