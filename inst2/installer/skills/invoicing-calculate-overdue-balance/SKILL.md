---
name: invoicing-calculate-overdue-balance
description: Business automation skill - calculate overdue balance (invoicing). Use when the user asks to calculate overdue balance or a close equivalent in the invoicing domain.
---

# Calculate Overdue Balance

## Goal
Help the user calculate overdue balance accurately and efficiently as part of Dacexy business automation (invoicing category).
