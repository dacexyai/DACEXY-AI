---
name: crm-find-stale-deals-2
description: Business automation skill - find stale deals 2 (crm). Use when the user asks to find stale deals 2 or a close equivalent in the crm domain.
---

# Find Stale Deals 2

## Goal
Help the user find stale deals 2 accurately and efficiently as part of Dacexy business automation (crm category).
