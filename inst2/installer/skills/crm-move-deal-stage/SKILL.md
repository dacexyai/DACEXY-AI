---
name: crm-move-deal-stage
description: Business automation skill - move deal stage (crm). Use when the user asks to move deal stage or a close equivalent in the crm domain.
---

# Move Deal Stage

## Goal
Help the user move deal stage accurately and efficiently as part of Dacexy business automation (crm category).
