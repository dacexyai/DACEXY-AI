---
name: support-summarize-support-ticket-trends-2
description: Business automation skill - summarize support ticket trends 2 (support). Use when the user asks to summarize support ticket trends 2 or a close equivalent in the support domain.
---

# Summarize Support Ticket Trends 2

## Goal
Help the user summarize support ticket trends 2 accurately and efficiently as part of Dacexy business automation (support category).
