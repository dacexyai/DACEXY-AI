---
name: support-escalate-urgent-ticket-5
description: Business automation skill - escalate urgent ticket 5 (support). Use when the user asks to escalate urgent ticket 5 or a close equivalent in the support domain.
---

# Escalate Urgent Ticket 5

## Goal
Help the user escalate urgent ticket 5 accurately and efficiently as part of Dacexy business automation (support category).
