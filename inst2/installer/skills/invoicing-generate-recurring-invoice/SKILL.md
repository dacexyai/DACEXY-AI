---
name: invoicing-generate-recurring-invoice
description: Business automation skill - generate recurring invoice (invoicing). Use when the user asks to generate recurring invoice or a close equivalent in the invoicing domain.
---

# Generate Recurring Invoice

## Goal
Help the user generate recurring invoice accurately and efficiently as part of Dacexy business automation (invoicing category).
