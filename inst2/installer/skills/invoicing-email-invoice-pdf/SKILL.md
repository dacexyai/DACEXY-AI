---
name: invoicing-email-invoice-pdf
description: Business automation skill - email invoice pdf (invoicing). Use when the user asks to email invoice pdf or a close equivalent in the invoicing domain.
---

# Email Invoice Pdf

## Goal
Help the user email invoice pdf accurately and efficiently as part of Dacexy business automation (invoicing category).
