---
name: support-triage-support-ticket-priority-4
description: Business automation skill - triage support ticket priority 4 (support). Use when the user asks to triage support ticket priority 4 or a close equivalent in the support domain.
---

# Triage Support Ticket Priority 4

## Goal
Help the user triage support ticket priority 4 accurately and efficiently as part of Dacexy business automation (support category).
