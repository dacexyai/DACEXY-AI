---
name: sales-build-sales-sequence-5
description: Business automation skill - build sales sequence 5 (sales). Use when the user asks to build sales sequence 5 or a close equivalent in the sales domain.
---

# Build Sales Sequence 5

## Goal
Help the user build sales sequence 5 accurately and efficiently as part of Dacexy business automation (sales category).
