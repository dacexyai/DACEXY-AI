---
name: crm-merge-duplicate-contacts-5
description: Business automation skill - merge duplicate contacts 5 (crm). Use when the user asks to merge duplicate contacts 5 or a close equivalent in the crm domain.
---

# Merge Duplicate Contacts 5

## Goal
Help the user merge duplicate contacts 5 accurately and efficiently as part of Dacexy business automation (crm category).
