---
name: ecommerce-process-return-request-2
description: Business automation skill - process return request 2 (ecommerce). Use when the user asks to process return request 2 or a close equivalent in the ecommerce domain.
---

# Process Return Request 2

## Goal
Help the user process return request 2 accurately and efficiently as part of Dacexy business automation (ecommerce category).
