---
name: crm-move-deal-stage-3
description: Business automation skill - move deal stage 3 (crm). Use when the user asks to move deal stage 3 or a close equivalent in the crm domain.
---

# Move Deal Stage 3

## Goal
Help the user move deal stage 3 accurately and efficiently as part of Dacexy business automation (crm category).
