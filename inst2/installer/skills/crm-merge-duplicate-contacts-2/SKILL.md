---
name: crm-merge-duplicate-contacts-2
description: Business automation skill - merge duplicate contacts 2 (crm). Use when the user asks to merge duplicate contacts 2 or a close equivalent in the crm domain.
---

# Merge Duplicate Contacts 2

## Goal
Help the user merge duplicate contacts 2 accurately and efficiently as part of Dacexy business automation (crm category).
