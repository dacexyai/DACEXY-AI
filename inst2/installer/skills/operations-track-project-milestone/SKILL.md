---
name: operations-track-project-milestone
description: Business automation skill - track project milestone (operations). Use when the user asks to track project milestone or a close equivalent in the operations domain.
---

# Track Project Milestone

## Goal
Help the user track project milestone accurately and efficiently as part of Dacexy business automation (operations category).
