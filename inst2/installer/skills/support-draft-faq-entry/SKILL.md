---
name: support-draft-faq-entry
description: Business automation skill - draft FAQ entry (support). Use when the user asks to draft FAQ entry or a close equivalent in the support domain.
---

# Draft Faq Entry

## Goal
Help the user draft FAQ entry accurately and efficiently as part of Dacexy business automation (support category).
