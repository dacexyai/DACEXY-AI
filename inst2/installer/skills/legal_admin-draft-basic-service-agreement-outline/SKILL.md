---
name: legal_admin-draft-basic-service-agreement-outline
description: Business automation skill - draft basic service agreement outline (legal admin). Use when the user asks to draft basic service agreement outline or a close equivalent in the legal admin domain.
---

# Draft Basic Service Agreement Outline

## Goal
Help the user draft basic service agreement outline accurately and efficiently as part of Dacexy business automation (legal admin category).
