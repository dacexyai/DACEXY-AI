---
name: crm-segment-customers-by-value
description: Business automation skill - segment customers by value (crm). Use when the user asks to segment customers by value or a close equivalent in the crm domain.
---

# Segment Customers By Value

## Goal
Help the user segment customers by value accurately and efficiently as part of Dacexy business automation (crm category).
