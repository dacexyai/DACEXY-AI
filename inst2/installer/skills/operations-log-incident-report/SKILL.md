---
name: operations-log-incident-report
description: Business automation skill - log incident report (operations). Use when the user asks to log incident report or a close equivalent in the operations domain.
---

# Log Incident Report

## Goal
Help the user log incident report accurately and efficiently as part of Dacexy business automation (operations category).
