---
name: finance-calculate-burn-rate-5
description: Business automation skill - calculate burn rate 5 (finance). Use when the user asks to calculate burn rate 5 or a close equivalent in the finance domain.
---

# Calculate Burn Rate 5

## Goal
Help the user calculate burn rate 5 accurately and efficiently as part of Dacexy business automation (finance category).
