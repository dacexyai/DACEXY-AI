---
name: crm-update-contact-5
description: Business automation skill - update contact 5 (crm). Use when the user asks to update contact 5 or a close equivalent in the crm domain.
---

# Update Contact 5

## Goal
Help the user update contact 5 accurately and efficiently as part of Dacexy business automation (crm category).
