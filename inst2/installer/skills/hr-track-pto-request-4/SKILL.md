---
name: hr-track-pto-request-4
description: Business automation skill - track PTO request 4 (hr). Use when the user asks to track PTO request 4 or a close equivalent in the hr domain.
---

# Track Pto Request 4

## Goal
Help the user track PTO request 4 accurately and efficiently as part of Dacexy business automation (hr category).
