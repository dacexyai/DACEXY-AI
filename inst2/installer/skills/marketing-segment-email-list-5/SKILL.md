---
name: marketing-segment-email-list-5
description: Business automation skill - segment email list 5 (marketing). Use when the user asks to segment email list 5 or a close equivalent in the marketing domain.
---

# Segment Email List 5

## Goal
Help the user segment email list 5 accurately and efficiently as part of Dacexy business automation (marketing category).
