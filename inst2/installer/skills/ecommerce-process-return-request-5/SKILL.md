---
name: ecommerce-process-return-request-5
description: Business automation skill - process return request 5 (ecommerce). Use when the user asks to process return request 5 or a close equivalent in the ecommerce domain.
---

# Process Return Request 5

## Goal
Help the user process return request 5 accurately and efficiently as part of Dacexy business automation (ecommerce category).
