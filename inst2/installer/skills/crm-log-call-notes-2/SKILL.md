---
name: crm-log-call-notes-2
description: Business automation skill - log call notes 2 (crm). Use when the user asks to log call notes 2 or a close equivalent in the crm domain.
---

# Log Call Notes 2

## Goal
Help the user log call notes 2 accurately and efficiently as part of Dacexy business automation (crm category).
