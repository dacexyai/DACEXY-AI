---
name: finance-calculate-burn-rate-2
description: Business automation skill - calculate burn rate 2 (finance). Use when the user asks to calculate burn rate 2 or a close equivalent in the finance domain.
---

# Calculate Burn Rate 2

## Goal
Help the user calculate burn rate 2 accurately and efficiently as part of Dacexy business automation (finance category).
