---
name: sales-draft-cold-outreach-email
description: Business automation skill - draft cold outreach email (sales). Use when the user asks to draft cold outreach email or a close equivalent in the sales domain.
---

# Draft Cold Outreach Email

## Goal
Help the user draft cold outreach email accurately and efficiently as part of Dacexy business automation (sales category).
