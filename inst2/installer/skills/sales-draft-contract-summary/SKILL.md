---
name: sales-draft-contract-summary
description: Business automation skill - draft contract summary (sales). Use when the user asks to draft contract summary or a close equivalent in the sales domain.
---

# Draft Contract Summary

## Goal
Help the user draft contract summary accurately and efficiently as part of Dacexy business automation (sales category).
