---
name: support-draft-apology-email
description: Business automation skill - draft apology email (support). Use when the user asks to draft apology email or a close equivalent in the support domain.
---

# Draft Apology Email

## Goal
Help the user draft apology email accurately and efficiently as part of Dacexy business automation (support category).
