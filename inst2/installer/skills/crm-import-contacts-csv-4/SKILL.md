---
name: crm-import-contacts-csv-4
description: Business automation skill - import contacts csv 4 (crm). Use when the user asks to import contacts csv 4 or a close equivalent in the crm domain.
---

# Import Contacts Csv 4

## Goal
Help the user import contacts csv 4 accurately and efficiently as part of Dacexy business automation (crm category).
