---
name: operations-generate-status-report
description: Business automation skill - generate status report (operations). Use when the user asks to generate status report or a close equivalent in the operations domain.
---

# Generate Status Report

## Goal
Help the user generate status report accurately and efficiently as part of Dacexy business automation (operations category).
