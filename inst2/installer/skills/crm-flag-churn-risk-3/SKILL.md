---
name: crm-flag-churn-risk-3
description: Business automation skill - flag churn risk 3 (crm). Use when the user asks to flag churn risk 3 or a close equivalent in the crm domain.
---

# Flag Churn Risk 3

## Goal
Help the user flag churn risk 3 accurately and efficiently as part of Dacexy business automation (crm category).
