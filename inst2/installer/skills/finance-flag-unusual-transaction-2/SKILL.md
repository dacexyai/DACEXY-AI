---
name: finance-flag-unusual-transaction-2
description: Business automation skill - flag unusual transaction 2 (finance). Use when the user asks to flag unusual transaction 2 or a close equivalent in the finance domain.
---

# Flag Unusual Transaction 2

## Goal
Help the user flag unusual transaction 2 accurately and efficiently as part of Dacexy business automation (finance category).
