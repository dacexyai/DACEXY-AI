---
name: invoicing-bulk-invoice-customers-5
description: Business automation skill - bulk invoice customers 5 (invoicing). Use when the user asks to bulk invoice customers 5 or a close equivalent in the invoicing domain.
---

# Bulk Invoice Customers 5

## Goal
Help the user bulk invoice customers 5 accurately and efficiently as part of Dacexy business automation (invoicing category).
