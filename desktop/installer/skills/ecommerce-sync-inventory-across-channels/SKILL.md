---
name: ecommerce-sync-inventory-across-channels
description: Business automation skill - sync inventory across channels (ecommerce). Use when the user asks to sync inventory across channels or a close equivalent in the ecommerce domain.
---

# Sync Inventory Across Channels

## Goal
Help the user sync inventory across channels accurately and efficiently as part of Dacexy business automation (ecommerce category).
