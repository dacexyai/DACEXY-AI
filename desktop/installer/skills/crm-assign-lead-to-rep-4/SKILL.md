---
name: crm-assign-lead-to-rep-4
description: Business automation skill - assign lead to rep 4 (crm). Use when the user asks to assign lead to rep 4 or a close equivalent in the crm domain.
---

# Assign Lead To Rep 4

## Goal
Help the user assign lead to rep 4 accurately and efficiently as part of Dacexy business automation (crm category).
