---
name: support-close-resolved-ticket-2
description: Business automation skill - close resolved ticket 2 (support). Use when the user asks to close resolved ticket 2 or a close equivalent in the support domain.
---

# Close Resolved Ticket 2

## Goal
Help the user close resolved ticket 2 accurately and efficiently as part of Dacexy business automation (support category).
