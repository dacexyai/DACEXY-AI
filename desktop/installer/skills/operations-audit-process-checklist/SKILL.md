---
name: operations-audit-process-checklist
description: Business automation skill - audit process checklist (operations). Use when the user asks to audit process checklist or a close equivalent in the operations domain.
---

# Audit Process Checklist

## Goal
Help the user audit process checklist accurately and efficiently as part of Dacexy business automation (operations category).
