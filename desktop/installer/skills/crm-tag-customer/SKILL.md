---
name: crm-tag-customer
description: Business automation skill - tag customer (crm). Use when the user asks to tag customer or a close equivalent in the crm domain.
---

# Tag Customer

## Goal
Help the user tag customer accurately and efficiently as part of Dacexy business automation (crm category).
