---
name: finance-categorize-expense
description: Business automation skill - categorize expense (finance). Use when the user asks to categorize expense or a close equivalent in the finance domain.
---

# Categorize Expense

## Goal
Help the user categorize expense accurately and efficiently as part of Dacexy business automation (finance category).
