---
name: support-draft-apology-email-2
description: Business automation skill - draft apology email 2 (support). Use when the user asks to draft apology email 2 or a close equivalent in the support domain.
---

# Draft Apology Email 2

## Goal
Help the user draft apology email 2 accurately and efficiently as part of Dacexy business automation (support category).
