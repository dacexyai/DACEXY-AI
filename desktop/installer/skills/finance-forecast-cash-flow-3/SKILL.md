---
name: finance-forecast-cash-flow-3
description: Business automation skill - forecast cash flow 3 (finance). Use when the user asks to forecast cash flow 3 or a close equivalent in the finance domain.
---

# Forecast Cash Flow 3

## Goal
Help the user forecast cash flow 3 accurately and efficiently as part of Dacexy business automation (finance category).
