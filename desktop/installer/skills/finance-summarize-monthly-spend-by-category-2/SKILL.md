---
name: finance-summarize-monthly-spend-by-category-2
description: Business automation skill - summarize monthly spend by category 2 (finance). Use when the user asks to summarize monthly spend by category 2 or a close equivalent in the finance domain.
---

# Summarize Monthly Spend By Category 2

## Goal
Help the user summarize monthly spend by category 2 accurately and efficiently as part of Dacexy business automation (finance category).
