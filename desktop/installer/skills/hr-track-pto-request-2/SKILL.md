---
name: hr-track-pto-request-2
description: Business automation skill - track PTO request 2 (hr). Use when the user asks to track PTO request 2 or a close equivalent in the hr domain.
---

# Track Pto Request 2

## Goal
Help the user track PTO request 2 accurately and efficiently as part of Dacexy business automation (hr category).
