---
name: marketing-write-landing-page-copy
description: Business automation skill - write landing page copy (marketing). Use when the user asks to write landing page copy or a close equivalent in the marketing domain.
---

# Write Landing Page Copy

## Goal
Help the user write landing page copy accurately and efficiently as part of Dacexy business automation (marketing category).
