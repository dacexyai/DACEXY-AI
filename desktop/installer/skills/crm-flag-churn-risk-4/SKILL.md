---
name: crm-flag-churn-risk-4
description: Business automation skill - flag churn risk 4 (crm). Use when the user asks to flag churn risk 4 or a close equivalent in the crm domain.
---

# Flag Churn Risk 4

## Goal
Help the user flag churn risk 4 accurately and efficiently as part of Dacexy business automation (crm category).
