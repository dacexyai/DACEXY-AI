---
name: finance-calculate-burn-rate
description: Business automation skill - calculate burn rate (finance). Use when the user asks to calculate burn rate or a close equivalent in the finance domain.
---

# Calculate Burn Rate

## Goal
Help the user calculate burn rate accurately and efficiently as part of Dacexy business automation (finance category).
