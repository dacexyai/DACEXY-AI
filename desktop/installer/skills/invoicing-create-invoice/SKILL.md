...
description: Business automation skill - create invoice (invoicing). Use when the user asks to create invoice or a close equivalent in the invoicing domain.
---

# Create Invoice

## Goal
Help the user create invoice accurately and efficiently as part of Dacexy business automation (invoicing category).
