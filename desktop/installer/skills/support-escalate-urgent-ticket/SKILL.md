---
name: support-escalate-urgent-ticket
description: Business automation skill - escalate urgent ticket (support). Use when the user asks to escalate urgent ticket or a close equivalent in the support domain.
---

# Escalate Urgent Ticket

## Goal
Help the user escalate urgent ticket accurately and efficiently as part of Dacexy business automation (support category).
