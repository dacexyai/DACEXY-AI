---
name: ecommerce-flag-low-stock-sku-3
description: Business automation skill - flag low stock SKU 3 (ecommerce). Use when the user asks to flag low stock SKU 3 or a close equivalent in the ecommerce domain.
---

# Flag Low Stock Sku 3

## Goal
Help the user flag low stock SKU 3 accurately and efficiently as part of Dacexy business automation (ecommerce category).
