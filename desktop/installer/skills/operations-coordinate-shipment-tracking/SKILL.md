---
name: operations-coordinate-shipment-tracking
description: Business automation skill - coordinate shipment tracking (operations). Use when the user asks to coordinate shipment tracking or a close equivalent in the operations domain.
---

# Coordinate Shipment Tracking

## Goal
Help the user coordinate shipment tracking accurately and efficiently as part of Dacexy business automation (operations category).
