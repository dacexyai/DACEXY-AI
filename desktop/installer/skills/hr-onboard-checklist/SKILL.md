---
name: hr-onboard-checklist
description: Business automation skill - onboard checklist (hr). Use when the user asks to onboard checklist or a close equivalent in the hr domain.
---

# Onboard Checklist

## Goal
Help the user onboard checklist accurately and efficiently as part of Dacexy business automation (hr category).
