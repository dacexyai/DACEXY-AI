---
name: operations-assign-task-to-team-member
description: Business automation skill - assign task to team member (operations). Use when the user asks to assign task to team member or a close equivalent in the operations domain.
---

# Assign Task To Team Member

## Goal
Help the user assign task to team member accurately and efficiently as part of Dacexy business automation (operations category).
