---
name: crm-tag-customer-5
description: Business automation skill - tag customer 5 (crm). Use when the user asks to tag customer 5 or a close equivalent in the crm domain.
---

# Tag Customer 5

## Goal
Help the user tag customer 5 accurately and efficiently as part of Dacexy business automation (crm category).
