---
name: crm-log-lead
description: Business automation skill - log lead (crm). Use when the user asks to log lead or a close equivalent in the crm domain.
---

# Log Lead

## Goal
Help the user log lead accurately and efficiently as part of Dacexy business automation (crm category).
