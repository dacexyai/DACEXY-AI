---
name: crm-tag-customer-4
description: Business automation skill - tag customer 4 (crm). Use when the user asks to tag customer 4 or a close equivalent in the crm domain.
---

# Tag Customer 4

## Goal
Help the user tag customer 4 accurately and efficiently as part of Dacexy business automation (crm category).
