---
name: marketing-segment-email-list
description: Business automation skill - segment email list (marketing). Use when the user asks to segment email list or a close equivalent in the marketing domain.
---

# Segment Email List

## Goal
Help the user segment email list accurately and efficiently as part of Dacexy business automation (marketing category).
