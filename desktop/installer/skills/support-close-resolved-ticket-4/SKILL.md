---
name: support-close-resolved-ticket-4
description: Business automation skill - close resolved ticket 4 (support). Use when the user asks to close resolved ticket 4 or a close equivalent in the support domain.
---

# Close Resolved Ticket 4

## Goal
Help the user close resolved ticket 4 accurately and efficiently as part of Dacexy business automation (support category).
