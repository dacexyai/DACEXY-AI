---
name: marketing-create-promo-discount-code-3
description: Business automation skill - create promo discount code 3 (marketing). Use when the user asks to create promo discount code 3 or a close equivalent in the marketing domain.
---

# Create Promo Discount Code 3

## Goal
Help the user create promo discount code 3 accurately and efficiently as part of Dacexy business automation (marketing category).
