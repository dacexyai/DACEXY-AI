---
name: sales-build-sales-proposal-2
description: Business automation skill - build sales proposal 2 (sales). Use when the user asks to build sales proposal 2 or a close equivalent in the sales domain.
---

# Build Sales Proposal 2

## Goal
Help the user build sales proposal 2 accurately and efficiently as part of Dacexy business automation (sales category).
