---
name: sales-forecast-pipeline-revenue
description: Business automation skill - forecast pipeline revenue (sales). Use when the user asks to forecast pipeline revenue or a close equivalent in the sales domain.
---

# Forecast Pipeline Revenue

## Goal
Help the user forecast pipeline revenue accurately and efficiently as part of Dacexy business automation (sales category).
