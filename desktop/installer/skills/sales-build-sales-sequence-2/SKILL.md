---
name: sales-build-sales-sequence-2
description: Business automation skill - build sales sequence 2 (sales). Use when the user asks to build sales sequence 2 or a close equivalent in the sales domain.
---

# Build Sales Sequence 2

## Goal
Help the user build sales sequence 2 accurately and efficiently as part of Dacexy business automation (sales category).
