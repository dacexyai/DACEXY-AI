---
name: finance-build-simple-financial-model
description: Business automation skill - build simple financial model (finance). Use when the user asks to build simple financial model or a close equivalent in the finance domain.
---

# Build Simple Financial Model

## Goal
Help the user build simple financial model accurately and efficiently as part of Dacexy business automation (finance category).
