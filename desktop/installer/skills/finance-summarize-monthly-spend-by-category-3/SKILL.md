---
name: finance-summarize-monthly-spend-by-category-3
description: Business automation skill - summarize monthly spend by category 3 (finance). Use when the user asks to summarize monthly spend by category 3 or a close equivalent in the finance domain.
---

# Summarize Monthly Spend By Category 3

## Goal
Help the user summarize monthly spend by category 3 accurately and efficiently as part of Dacexy business automation (finance category).
