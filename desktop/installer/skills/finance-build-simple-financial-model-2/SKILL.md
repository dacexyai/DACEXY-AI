---
name: finance-build-simple-financial-model-2
description: Business automation skill - build simple financial model 2 (finance). Use when the user asks to build simple financial model 2 or a close equivalent in the finance domain.
---

# Build Simple Financial Model 2

## Goal
Help the user build simple financial model 2 accurately and efficiently as part of Dacexy business automation (finance category).
