---
name: invoicing-email-invoice-pdf-2
description: Business automation skill - email invoice pdf 2 (invoicing). Use when the user asks to email invoice pdf 2 or a close equivalent in the invoicing domain.
---

# Email Invoice Pdf 2

## Goal
Help the user email invoice pdf 2 accurately and efficiently as part of Dacexy business automation (invoicing category).
