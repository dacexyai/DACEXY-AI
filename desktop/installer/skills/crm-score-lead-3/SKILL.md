---
name: crm-score-lead-3
description: Business automation skill - score lead 3 (crm). Use when the user asks to score lead 3 or a close equivalent in the crm domain.
---

# Score Lead 3

## Goal
Help the user score lead 3 accurately and efficiently as part of Dacexy business automation (crm category).
