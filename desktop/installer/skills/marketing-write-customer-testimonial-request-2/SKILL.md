---
name: marketing-write-customer-testimonial-request-2
description: Business automation skill - write customer testimonial request 2 (marketing). Use when the user asks to write customer testimonial request 2 or a close equivalent in the marketing domain.
---

# Write Customer Testimonial Request 2

## Goal
Help the user write customer testimonial request 2 accurately and efficiently as part of Dacexy business automation (marketing category).
