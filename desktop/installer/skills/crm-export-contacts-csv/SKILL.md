---
name: crm-export-contacts-csv
description: Business automation skill - export contacts csv (crm). Use when the user asks to export contacts csv or a close equivalent in the crm domain.
---

# Export Contacts Csv

## Goal
Help the user export contacts csv accurately and efficiently as part of Dacexy business automation (crm category).
