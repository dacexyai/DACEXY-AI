---
name: sales-draft-renewal-email-2
description: Business automation skill - draft renewal email 2 (sales). Use when the user asks to draft renewal email 2 or a close equivalent in the sales domain.
---

# Draft Renewal Email 2

## Goal
Help the user draft renewal email 2 accurately and efficiently as part of Dacexy business automation (sales category).
