---
name: invoicing-match-payment-to-invoice-5
description: Business automation skill - match payment to invoice 5 (invoicing). Use when the user asks to match payment to invoice 5 or a close equivalent in the invoicing domain.
---

# Match Payment To Invoice 5

## Goal
Help the user match payment to invoice 5 accurately and efficiently as part of Dacexy business automation (invoicing category).
