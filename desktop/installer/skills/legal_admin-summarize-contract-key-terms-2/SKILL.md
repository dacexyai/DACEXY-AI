---
name: legal_admin-summarize-contract-key-terms-2
description: Business automation skill - summarize contract key terms 2 (legal admin). Use when the user asks to summarize contract key terms 2 or a close equivalent in the legal admin domain.
---

# Summarize Contract Key Terms 2

## Goal
Help the user summarize contract key terms 2 accurately and efficiently as part of Dacexy business automation (legal admin category).
