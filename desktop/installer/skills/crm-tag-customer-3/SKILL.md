---
name: crm-tag-customer-3
description: Business automation skill - tag customer 3 (crm). Use when the user asks to tag customer 3 or a close equivalent in the crm domain.
---

# Tag Customer 3

## Goal
Help the user tag customer 3 accurately and efficiently as part of Dacexy business automation (crm category).
