---
name: sales-calculate-deal-discount-3
description: Business automation skill - calculate deal discount 3 (sales). Use when the user asks to calculate deal discount 3 or a close equivalent in the sales domain.
---

# Calculate Deal Discount 3

## Goal
Help the user calculate deal discount 3 accurately and efficiently as part of Dacexy business automation (sales category).
