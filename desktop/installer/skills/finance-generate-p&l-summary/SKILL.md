---
name: finance-generate-p&l-summary
description: Business automation skill - generate P&L summary (finance). Use when the user asks to generate P&L summary or a close equivalent in the finance domain.
---

# Generate P&L Summary

## Goal
Help the user generate P&L summary accurately and efficiently as part of Dacexy business automation (finance category).
