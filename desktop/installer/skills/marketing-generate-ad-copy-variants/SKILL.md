---
name: marketing-generate-ad-copy-variants
description: Business automation skill - generate ad copy variants (marketing). Use when the user asks to generate ad copy variants or a close equivalent in the marketing domain.
---

# Generate Ad Copy Variants

## Goal
Help the user generate ad copy variants accurately and efficiently as part of Dacexy business automation (marketing category).
