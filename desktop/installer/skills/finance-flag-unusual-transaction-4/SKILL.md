---
name: finance-flag-unusual-transaction-4
description: Business automation skill - flag unusual transaction 4 (finance). Use when the user asks to flag unusual transaction 4 or a close equivalent in the finance domain.
---

# Flag Unusual Transaction 4

## Goal
Help the user flag unusual transaction 4 accurately and efficiently as part of Dacexy business automation (finance category).
