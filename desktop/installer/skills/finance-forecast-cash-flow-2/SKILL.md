---
name: finance-forecast-cash-flow-2
description: Business automation skill - forecast cash flow 2 (finance). Use when the user asks to forecast cash flow 2 or a close equivalent in the finance domain.
---

# Forecast Cash Flow 2

## Goal
Help the user forecast cash flow 2 accurately and efficiently as part of Dacexy business automation (finance category).
