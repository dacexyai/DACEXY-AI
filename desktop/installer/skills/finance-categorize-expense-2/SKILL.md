---
name: finance-categorize-expense-2
description: Business automation skill - categorize expense 2 (finance). Use when the user asks to categorize expense 2 or a close equivalent in the finance domain.
---

# Categorize Expense 2

## Goal
Help the user categorize expense 2 accurately and efficiently as part of Dacexy business automation (finance category).
