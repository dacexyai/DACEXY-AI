---
name: hr-draft-termination-checklist
description: Business automation skill - draft termination checklist (hr). Use when the user asks to draft termination checklist or a close equivalent in the hr domain.
---

# Draft Termination Checklist

## Goal
Help the user draft termination checklist accurately and efficiently as part of Dacexy business automation (hr category).
