---
name: ecommerce-track-order-status
description: Business automation skill - track order status (ecommerce). Use when the user asks to track order status or a close equivalent in the ecommerce domain.
---

# Track Order Status

## Goal
Help the user track order status accurately and efficiently as part of Dacexy business automation (ecommerce category).
