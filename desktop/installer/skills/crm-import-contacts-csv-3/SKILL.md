---
name: crm-import-contacts-csv-3
description: Business automation skill - import contacts csv 3 (crm). Use when the user asks to import contacts csv 3 or a close equivalent in the crm domain.
---

# Import Contacts Csv 3

## Goal
Help the user import contacts csv 3 accurately and efficiently as part of Dacexy business automation (crm category).
