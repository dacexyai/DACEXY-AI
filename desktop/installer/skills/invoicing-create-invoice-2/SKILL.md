---
name: invoicing-create-invoice-2
description: Business automation skill - create invoice 2 (invoicing). Use when the user asks to create invoice 2 or a close equivalent in the invoicing domain.
---

# Create Invoice 2

## Goal
Help the user create invoice 2 accurately and efficiently as part of Dacexy business automation (invoicing category).
