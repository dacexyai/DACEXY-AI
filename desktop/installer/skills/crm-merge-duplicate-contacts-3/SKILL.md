---
name: crm-merge-duplicate-contacts-3
description: Business automation skill - merge duplicate contacts 3 (crm). Use when the user asks to merge duplicate contacts 3 or a close equivalent in the crm domain.
---

# Merge Duplicate Contacts 3

## Goal
Help the user merge duplicate contacts 3 accurately and efficiently as part of Dacexy business automation (crm category).
