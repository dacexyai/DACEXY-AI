---
name: finance-flag-unusual-transaction
description: Business automation skill - flag unusual transaction (finance). Use when the user asks to flag unusual transaction or a close equivalent in the finance domain.
---

# Flag Unusual Transaction

## Goal
Help the user flag unusual transaction accurately and efficiently as part of Dacexy business automation (finance category).
