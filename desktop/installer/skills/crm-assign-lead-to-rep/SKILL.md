---
name: crm-assign-lead-to-rep
description: Business automation skill - assign lead to rep (crm). Use when the user asks to assign lead to rep or a close equivalent in the crm domain.
---

# Assign Lead To Rep

## Goal
Help the user assign lead to rep accurately and efficiently as part of Dacexy business automation (crm category).
