---
name: invoicing-generate-recurring-invoice-2
description: Business automation skill - generate recurring invoice 2 (invoicing). Use when the user asks to generate recurring invoice 2 or a close equivalent in the invoicing domain.
---

# Generate Recurring Invoice 2

## Goal
Help the user generate recurring invoice 2 accurately and efficiently as part of Dacexy business automation (invoicing category).
