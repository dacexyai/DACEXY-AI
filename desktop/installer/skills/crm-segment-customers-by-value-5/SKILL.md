---
name: crm-segment-customers-by-value-5
description: Business automation skill - segment customers by value 5 (crm). Use when the user asks to segment customers by value 5 or a close equivalent in the crm domain.
---

# Segment Customers By Value 5

## Goal
Help the user segment customers by value 5 accurately and efficiently as part of Dacexy business automation (crm category).
